...
#pragma warning restore CA1308 // Normalize strings to uppercase
            return new Dictionary<string, KnownIssue>()
            {
                ...
                { $"get-message-in-mime-{lng}-Beta-compiles", new KnownIssue(Metadata, "Message entity doesn't have hasStream=true.") },
                { $"get-message-in-mime-{lng}-V1-compiles", new KnownIssue(Metadata, "Message entity doesn't have hasStream=true.") },
                ...
                { $"post-reply-{lng}-Beta-compiles", new KnownIssue(HTTP, HttpSnippetWrong + ": Odata.Type for concreate Attachment type should be added") },
                { $"post-reply-{lng}-V1-compiles", new KnownIssue(HTTP, HttpSnippetWrong + ": Odata.Type for concreate Attachment type should be added") },
